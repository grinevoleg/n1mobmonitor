...
_COMMON_RU = {
    ...
    "field.store_release_date": "Дата релиза (iTunes)",
...
_COMMON_EN = {
    ...
    "field.store_release_date": "Release date (iTunes)",
...
_ALERTS_RU = {
    ...
    "type.store_release_change": "Дата релиза (iTunes)",
...
_ALERTS_EN = {
    ...
    "type.store_release_change": "iTunes release date",
...
def alerts_js_bundle(locale: str) -> Dict[str, str]:
    ...
    return {
        ...
        "type_store_release_change": t(loc, "alerts.type.store_release_change"),
